...
Who needs what done? Cite the business process or policy. Map inputs → agent/tools
...
Link relevant primary sources. What do they establish, what is uncertain, and why
is this question or replication useful? Disclose an Agent Assurance connection if used.
