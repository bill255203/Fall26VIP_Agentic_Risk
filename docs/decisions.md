...
| D008 | 2026-09-16 | accepted | Start the schedule from the first cohort meeting, with no required repository submission before it. Use adjustable working targets from kickoff: M1 +7 days, M2 +14, M3 +21, M4 +35, full draft +42, M5 +56. Give onboarding a full week and distribute early research tasks across the cohort. | The owner confirmed that the meeting is not scheduled and explicitly requested relative dates; [scope issue #15](https://github.com/zhongnz/Fall26VIP_Agentic_Risk/issues/15) records the change. Calendar due dates remain unset until kickoff is confirmed; the instructor checks holidays and the course deadline before publishing dates. Acceptance covers the relative-schedule approach; offsets remain working project targets. The [semester schedule](semester-plan.md#calendar-and-working-targets) is authoritative; D003's study selection remains pending. |
