...
Tandon fall break on October 12 and the Monday class schedule on October 14;
reduce workload or adjust the slot if needed. The [NYU Tandon calendar](https://engineering.nyu.edu/academics/registration/school-calendar),
checked September 23, also lists Thanksgiving recess on November 26–27 and final
exams December 16–22. Follow course announcements for actual meeting times. Preserve remaining term time for agreed review and repairs;
...
Existing [#28](https://github.com/zhongnz/Fall26VIP_Agentic_Risk/issues/28)/#30 and PR [#29](https://github.com/zhongnz/Fall26VIP_Agentic_Risk/pull/29) remain valid onboarding/starter records.
