# Cohort meeting records

Keep one short Markdown file per meeting, named `YYYY-MM-DD.md` (add a short
suffix for a second meeting on the same date). Notes record evidence, decisions,
and owned next actions; they do not replace issues or contribution records.

Link notes from the current milestone's work. Record actual attendees only.
...
- Issue / PR / run / document link and what it establishes:
...
| Action | Owner | Issue | Target check-in |
| --- | --- | --- | --- |
| | | | |
